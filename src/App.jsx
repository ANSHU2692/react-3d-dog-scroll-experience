    ...
    <>
      <main>
        <div className="images">
          <img id="tommorowland" src="/tommorowland.png" alt="dog" />
          <img id="navy-pier" src="/navy-pier.png" alt="dog" />
          <img id="msi-chicago" src="/msi-chicago.png" alt="dog" />
          <img id="phone" src="/phone.png" alt="dog" />
          <img id="kikk" src="/kikk.png" alt="dog" />
          <img id="kennedy" src="/kennedy.png" alt="dog" />
          <img id="opera" src="/opera.png" alt="dog" />
        </div>
        <Canvas
          id="canvas-elem"
          style={{
          ...
          <div className="top">
            <div className="left">
              <h3>
                ...
                <br /> Rerum, error alias. <br /> Fugit hic unde magni <br />
                repellat quod, similique
              </h3>
            </div>
            <div className="right"></div>
          </div>
          ...
          <div className="bottom">
            ...
            <div className="right">
              <p>
                ...
                Consequuntur, saepe. Quia odit aliquid voluptatibus minus natus
                saepe odio ut soluta iste ea fugit sunt maiores amet excepturi
                quos molestias tempora vel reprehenderit ipsa aperiam esse
                necessitatibus, nemo voluptas non? Porro aut praesentium quos
                non iusto facere soluta, ea corrupti expedita!
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Consequuntur, saepe. Quia odit aliquid voluptatibus minus natus
